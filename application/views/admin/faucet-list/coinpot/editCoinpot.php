            ...
            <div class="form-group">
              ...
              <select name="id_coin" id="id_coin" class="form-control">
                <?php foreach ($coins as $coin): ?>
                  <option value="<?= $coin['id'] ?>" <?= $coin['id'] == $coinpot['id_coin'] ? 'selected' : null ?> ><?= strtoupper($coin['code_coin']) ?></option>
                <?php endforeach ?>
              </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select name="status" id="status" class="form-control">
                <?php foreach ($status as $sts): ?>
                  <option value="<?= $sts ?>" <?= $sts == $coinpot['status'] ? 'selected' : null ?> ><?= ucfirst($sts) ?></option>
                <?php endforeach; ?>
              </select>
            </div>
            <div class="form-group">
