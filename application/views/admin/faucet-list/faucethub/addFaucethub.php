  ...
  <div class="card shadow">
    ...
    <div class="card-body">
      <form method="POST" action="<?= base_url('administrator/faucet-list/faucethub/add') ?>">
        <input type="hidden" name="id_faucethub" id="id_faucethub" value="<?= $uuid ?>">
        <div class="row">
          <div class="col-md-5 ml-5">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="timer" name="timer" placeholder="1 minutes" value="<?= set_value('timer') ?>">
          ...
          <div class="col-md-5">
            ...
            <label for="payment">Payment *</label>
              <input type="text" class="form-control" id="payment" name="payment" value="FaucetHub" readonly="" value="<?= set_value('payment') ?>">
