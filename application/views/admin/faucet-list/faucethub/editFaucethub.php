      	...
      	<div class="row">
          	...
          	<div class="form-group">
					  ...
					  <div class="form-group">
					    ...
					    <input type="number" class="form-control" id="timer" name="timer" required="" placeholder="1 minutes" value="<?= $faucethub['timer'] ?>">
					  </div>
					  <div class="form-group">
				  ...
				  <div class="col-md-5">
					  ...
					  <div class="form-group">
					    ...
					    <input type="number" class="form-control" id="withdrawal" name="withdrawal" required="" placeholder="0.00025000 BTC" value="<?= $faucethub['withdrawal'] ?>">
					  </div>
			  	</div>
				</div>
	    </div>
