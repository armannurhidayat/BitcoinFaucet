<div class="container-fluid">
  <div class="card shadow">
    <div class="card-header">
      ...
      <h6 class="m-0 mt-2 font-weight-bold text-primary text-right">Add Site</h6>
    </div>
    
    <div class="card-body">
      <form method="POST" action="<?= base_url('administrator/other-list/ptc/add') ?>">
        <div class="row">
          <div class="col-md-5 ml-5">
            <div class="form-group">
              <label for="nama">Site Name *</label>
              <input type="hidden" id="id_ptc" name="id_ptc" value="<?= $uuid ?>">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="link" id="link" style="min-height: 100px;" placeholder="https://link-site.com"><?= set_value('link') ?></textarea>
